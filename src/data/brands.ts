...
export const brands: Brand[] = [
  {
    slug: "viessmann",
    name: "Viessmann",
    description: "La Vitocal 300-G affiche un COP de 5,2 qui réduit la consommation électrique de 20% vs la concurrence. Prix élevé mais amorti en 7-9 ans grâce aux performances.",
    ...
    content: "Du point de vue du coût global sur 25 ans, la Vitocal 300-G est l'une des PAC les plus rentables du marché malgré un prix d'achat supérieur de 20-30%. La gamme Vitocal 300-G offre un COP de 4,8 à 5,2 en conditions normalisées, avec un compresseur Scroll EVI capable de produire de l'eau à 65°C pour les rénovations conservant des radiateurs haute température. La marque dispose du réseau d'installateurs partenaires le plus dense de France."
  },
  {
    slug: "nibe",
    name: "NIBE",
